-- =====================================================
-- COMPLETE SETUP: LINES TABLE + MACHINES LINE COLUMN
-- =====================================================
...
-- =====================================================
-- 5. ASSIGN MACHINES TO LINES
-- =====================================================

-- Assign JSW-1 to LINE-003 as requested
UPDATE machines 
SET line = 'LINE-003' 
WHERE machine_id = 'JSW-1';

-- Assign other machines to lines (examples)
