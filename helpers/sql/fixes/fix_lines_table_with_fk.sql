-- =====================================================
-- FIX LINES TABLE WITH PROPER FOREIGN KEY RELATIONSHIPS
-- =====================================================

-- First, drop the existing lines table if it exists
...
-- =====================================================
-- TEST SAMPLE DATA INSERTION (OPTIONAL)
-- =====================================================

-- Uncomment these lines to test with sample data:
/*
-- Insert a test line (make sure these machine IDs exist in your machines table)
...
('LINE-TEST-001', 'Test Line 1', 'Test production line', 'JSW-1', 'WITT-1', 'CONY-1', 'SEPL5208', 'Active', 'Unit 1');
