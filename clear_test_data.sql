...
UNION ALL
SELECT 'Job Work Challan Headers', COUNT(*) FROM store_job_work_challan
UNION ALL
SELECT 'Job Work Challan Items', COUNT(*) FROM store_job_work_challan_items
UNION ALL
...
UNION ALL
SELECT 'Job Work Challan Stock Entries', COUNT(*) FROM stock_ledger WHERE document_type = 'JOB_WORK_CHALLAN';
