-- Apply Raw Materials Migration with TDS Image Support
-- This script creates the raw_materials table with the new schema
...
-- Update the info modal description for raw materials
-- The application will now show the correct column headers:
-- Sl. No., Category, Type, Grade, Supplier, MFI, Density, TDS, Actions

PRINT 'Raw Materials migration completed successfully!';
PRINT 'New features added:';
PRINT '- TDS image support (tds_image field)';
PRINT '- Updated schema with category and type fields';
PRINT '- Support for null MFI and density values';
PRINT '- Remark field for additional notes'; 