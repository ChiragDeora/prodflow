...
-- This migration implements the comprehensive access control system with phone number approval
-- and granular permissions for the production scheduler
...
CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    role VARCHAR(20) CHECK (role IN ('admin', 'user', 'operator')) DEFAULT 'user',
...
-- Create module_permissions table for module-level access control
...
RETURNS VOID AS $$
BEGIN
    -- Insert default admin user (CEO)
    INSERT INTO user_profiles (id, full_name, email, phone_number, role, department)
    VALUES (
    ...
    -- Grant all module access to admin
    INSERT INTO module_permissions (user_id, module_name, access_level, granted_by)
    VALUES 
        ('00000000-0000-0000-0000-000000000001', 'master-data', 'admin', '00000000-0000-0000-0000-000000000001'),
        ('00000000-0000-0000-0000-000000000001', 'production-schedule', 'admin', '00000000-0000-0000-0000-000000000001'),
        ('00000000-0000-0000-0000-000000000001', 'operator-panel', 'admin', '00000000-0000-0000-0000-000000000001'),
        ('00000000-0000-0000-0000-000000000001', 'reports', 'admin', '00000000-0000-0000-0000-000000000001'),
        ('00000000-0000-0000-0000-000000000001', 'approvals', 'admin', '00000000-0000-0000-0000-000000000001'),
        ('00000000-0000-0000-0000-000000000001', 'admin', 'admin', '00000000-0000-0000-0000-000000000001'),
        ('00000000-0000-0000-0000-000000000001', 'profile', 'admin', '00000000-0000-0000-0000-000000000001')
